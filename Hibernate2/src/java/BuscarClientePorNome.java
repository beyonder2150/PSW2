...
public class BuscarClientePorNome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //busca para qualquer coluna
            Criteria criteria = sessao.createCriteria(Cliente.class);
            
            //configura o criteria
            //o primeiro nome é o da classe e o outro nome do html
            criteria.add(Restrictions.eq("nome",request.getParameter("nome")));
            
            //captura e armazena lista
            List<Cliente> resultado = criteria.list();
            
            out.println("Clientes encontrado: " +resultado.size());
